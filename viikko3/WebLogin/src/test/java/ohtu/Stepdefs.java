...
public class Stepdefs {
    ...
    public void aTooShortUsernameAndPasswordAndMatchingPasswordConfirmationAreEntered(String username,
            String password) {
        registerWith(username, password);
    }
    ...
    public void userWithUsernameAndPasswordIsTriedToBeCreated(String username, String password) {
        commandNewUserIsSelected();
        aTooShortUsernameAndPasswordAndMatchingPasswordConfirmationAreEntered(username, password);
